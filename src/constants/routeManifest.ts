...
export const ROUTE_MANIFEST: RouteDefinition[] = [
  ...
  { path: '/cliques/:cliqueId', page: 'CliqueDetail', protection: 'auth', description: 'Clique details and members', category: 'auth' },
  { path: '/cliques/:cliqueId/warmup', page: 'CliqueWarmUp', protection: 'auth', description: 'Clique warm-up room', category: 'auth' },
  { path: '/cliques/new', page: 'CliqueCreate', protection: 'auth', description: 'Create a new clique', category: 'auth' },
  { path: '/join/:code', page: 'JoinClique', protection: 'public', description: 'Join a clique via invite code', category: 'auth' },
