      ...
      <div className="container mx-auto px-4 py-16 md:py-24 lg:py-32">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex justify-center mb-8 animate-fade-in">
            <img src={wordmark} alt="OpenClique" className="h-10 md:h-12 text-foreground" />
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in [animation-delay:300ms]">
            ...
            <Button size="lg" asChild className="w-full sm:w-auto text-base px-8 bg-secondary text-secondary-foreground hover:bg-secondary/90">
              <Link to="/partners">{HERO.secondaryCta}</Link>
            </Button>
            <Button size="lg" asChild className="w-full sm:w-auto text-base px-8 bg-gold text-gold-foreground hover:bg-gold/90">
