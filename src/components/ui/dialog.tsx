...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // Mobile-first: sheet-style from bottom
        "fixed inset-x-0 bottom-0 z-50 grid w-full max-h-[85vh] overflow-y-auto gap-4 border-t bg-background p-6 pb-safe shadow-lg duration-200",
        // Mobile animations
        ...
        "sm:inset-auto sm:left-[50%] sm:top-[50%] sm:max-w-lg sm:translate-x-[-50%] sm:translate-y-[-50%] sm:rounded-lg sm:border sm:border-t sm:max-h-[90vh] sm:pb-6",
        ...
        // Touch-friendly rounded corners on mobile
